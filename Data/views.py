...
class RouterAjax(View):
    def get(self, request, *args, **kwargs):
        ...
        sql_inside_of_function = "select id, source, target, cost * (4-rtng_ccpx) * (4-rtng_mean) * (4-rtng_cbf7) as costly,cost * (4-rtng_ccpx)*(4-rtng_mean)*(4-rntg_cbf7) * case when one_way=0 then 1 else one_way END from \"Data_minnesotabiketrails\"\'"
